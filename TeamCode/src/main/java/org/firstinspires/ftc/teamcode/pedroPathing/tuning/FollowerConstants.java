...
public class FollowerConstants {
    ...
    private static double xMovement = 22.3838;
    private static double yMovement = 25.6523;
    ...
    public static double mass = 10; // scale later
    ...
    public static double forwardZeroPowerAcceleration = -47.044;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -64.0428;
