...
public class JTRightAuto2Spec extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // human player 1st cycle
            ...
            tracker.moveTo(50, -48, 0, 2, 0.5,0.8);
            // 1
            tracker.moveTo(10, -48, 0, 2, 0.5,0.9);
            tracker.moveTo(50, -48, 0, 2, 0.5,0.9);
            tracker.moveTo(50, -60, 0, 2, 0.5,0.8);
            // 2
            tracker.moveTo(10, -60, 0, 1, 0.5,0.9);
            ...
            tracker.moveTo(7.4, -42, 180, 0.1, 0.5, 0.6);
            claw.setPosition(1);
            sleep(500);
            // back away
        ...
        // 2nd specimen
            ...
            tracker.moveTo(25.85, -0.75, 0, 0.1, 0.5, 0.6);
            tracker.setMotorsOmni(0.2, 0, 0);
            arm.setTargetPosition(2000);
            sleep(1100);
            arm.setTargetPosition(3250);
        ...
        // human player 2nd cycle
            // get 2
            tracker.moveTo(22, -0.75, 0, 1, 0.5, 0.9);
            arm.setTargetPosition(1800);
